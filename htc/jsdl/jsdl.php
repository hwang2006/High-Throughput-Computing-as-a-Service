...
if ($mode == 'step2') {
 ...
 // dbg($info);
  ...
  print<<<EOS
<form name='it'>
<input onclick="copyit('it.select1')" type='button'  value='Select All' name='cpy'  style="font-family:Calibri; font-size:10pt; height:20; width:100; background:#EFEFEF; border:1 solid #808080; cursor:hand"><br>
...
<center><h2> JSDL </h2>
(It can not support Internet Explorer browser) </center>
